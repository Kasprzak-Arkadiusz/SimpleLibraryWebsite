        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReaderId1 = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Requests", x => x.RequestId);
                    table.ForeignKey(
                        name: "FK_Requests_AspNetUsers_ReaderId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Loans_AspNetUsers_ReaderId1",
                        column: x => x.ReaderId1,
                        principalSchema: "Identity",
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Loans_ReaderId1",
                schema: "Identity",
                table: "Loans",
                column: "ReaderId1");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_ReaderId1",
                schema: "Identity",
                table: "Requests",
                column: "ReaderId1");
